...
import cn.ouyang.lottery.common.enums.MQState;
...
public class ActivityProcessImpl implements IActivityProcess {
    ...
    public DrawProcessResult doDrawProcess(DrawProcessReq req) {
        ...
        Result recordDrawOrder = activityPartake.recordDrawOrder(drawOrderVO);
        if (!Constants.ResponseCode.SUCCESS.getCode().equals(recordDrawOrder.getCode())) {
            return new DrawProcessResult(recordDrawOrder.getCode(), recordDrawOrder.getInfo());
        }
